(function() {
    ...
    //intro frame 01
        ...
        t.from(copy01, 1, { y:"+=15",  rotation: .01, willChange: "transform", force3D:true, ease: Power3.easeOut, delay:4});

        t.to(copy02, 1, { autoAlpha:1, ease: Power3.easeOut, delay:4.3});
        t.from(copy02, 1, { y:"+=15",  rotation: .01, willChange: "transform", force3D:true, ease: Power3.easeOut, delay:4.3});

        t.to(copy03, 1, { autoAlpha:1, ease: Power3.easeOut, delay:4.6});
        t.from(copy03, 1, { y:"+=15",  rotation: .01, willChange: "transform", force3D:true, ease: Power3.easeOut, delay:4.6});
